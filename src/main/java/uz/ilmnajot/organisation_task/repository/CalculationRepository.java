...
//
//    @Query("SELECT e.firstName, e.lastName, c.amount, c.calculationType FROM calculations c JOIN c.employee e " +
//            "where c.calculationType IN (:calculationType) AND " +
//            "c.date between :hiredDate and : firedDate")
